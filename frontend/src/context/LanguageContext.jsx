...
export const TRANSLATIONS = {
  en: {
    ...
    signupPrompt: 'Enter your name, email and password to register in the database:',
    signinPrompt: 'Enter your credentials to access your audio news feed:',
    signUpTab: 'Sign Up (New User)',
    signInTab: 'Sign In (Existing)',
  ...
  hi: {
    ...
    signupPrompt: 'डेटाबेस में खाता बनाने के लिए अपना नाम, ईमेल और पासवर्ड दर्ज करें:',
    signinPrompt: 'अपने ऑडियो समाचारों तक पहुँचने के लिए क्रेडेंशियल्स दर्ज करें:',
    signUpTab: 'साइन अप (नया खाता)',
    signInTab: 'साइन इन (मौजूदा)',
    fullNameLabel: 'पूरा नाम',
    emailLabel: 'गूगल / कार्य ईमेल',
    passwordLabel: 'पासवर्ड',
    createBtn: 'खाता बनाएं और डेटाबेस में सहेजें',
    signInBtn: 'साइन इन करें',
    dbSecurityNote: 'एन्क्रिप्टेड और MongoDB डेटाबेस में सुरक्षित',
